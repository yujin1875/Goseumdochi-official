...
//    @Transactional
    public String encrypt(String plaintext) {
        String url = "http://34.64.149.50:5000/encrypt"; // Flask 서버 주소 + route 주소
        ...
        // input (JSON 형태)
        String param = String.format("{\"plaintext\" : \"%s\", \"password\" : \"%s\"}", plaintext, password);
    ...
    public String decrypt(String encryptText) {
        String url = "http://34.64.149.50:5000/decrypt";
        ...
        String param = String.format("{\"encrypted_text\" : \"%s\", \"password\" : \"%s\"}", encryptText, password);
